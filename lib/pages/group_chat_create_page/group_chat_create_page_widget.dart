...
import 'group_chat_create_page_model.dart';
export 'group_chat_create_page_model.dart';

class GroupChatCreatePageWidget extends StatefulWidget {
  const GroupChatCreatePageWidget({super.key});

  static String routeName = 'GroupChatCreatePage';
  static String routePath = '/groupChatCreatePage';

  @override
  State<GroupChatCreatePageWidget> createState() =>
      _GroupChatCreatePageWidgetState();
}

class _GroupChatCreatePageWidgetState extends State<GroupChatCreatePageWidget> {
  late GroupChatCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupChatCreatePageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.addToSelectedEmployeeList(FFAppState().userProfileData);
      safeSetState(() {});
    });
          ...
          child: Column(
            ...
            children: [
                    ...
                    Builder(
                      builder: (context) => FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          if (GetAllEmployeeAPICall.statusLayer1(
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  content: Text(
                                      'พบข้อผิดพลาด (${GetAllEmployeeAPICall.statusLayer1(
                                    (_model.getEmployee?.jsonBody ?? ''),
                                  )?.toString()})'),
                                  actions: [
                                    TextButton(
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final employeeListItem = _model.employeeListData.toList();
                        ...
                        return StreamBuilder<List<UserCustomRecord>>(
                          stream: queryUserCustomRecord(
                            queryBuilder: (userCustomRecord) =>
                              ...
                              'employee_id',
                              isEqualTo: employeeListItemItem.employeeCode,
                            ),
                            singleRecord: true,
                          ),
                              ...
                              child: Visibility(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      HapticFeedback.mediumImpact();
                                      if (_model.employeeListData
                                          .map((e) => e.employeeCode)
                                          .toList()
                                          .contains(employeeListItemItem
                                              .employeeCode)) {
                                        return;
                                      }
                                      _model.addToSelectedEmployeeList(
                                          UserProfileDataModelStruct(
                                        createdTime: containerUserCustomRecord
                                            .createdTime,
                                        email: containerUserCustomRecord.email,
                                        uid: containerUserCustomRecord.uid,
                                        imgProfile: containerUserCustomRecord
                                            .imgProfile,
                                        employeeId: containerUserCustomRecord
                                            .employeeId,
                                        fcmToken:
                                            containerUserCustomRecord.fcmToken,
                                        sawadChatRoomRef:
                                        ...
                                        imgProfileBlurHash:
                                            containerUserCustomRecord
                                                .imgProfileBlurHash,
                                        fullName: employeeListItemItem.fullName,
                                      ));
                                      safeSetState(() {});
                                    },
                                    child: Container(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                              Text(
                                                                            employeeListItemItem.position.maybeHandleOverflow(
                                                                              maxChars: 50,
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  _model.addToSelectedEmployeeList(
                                                                    ...
                                                                    createdTime:
                                                                        containerUserCustomRecord
                                                                            .createdTime,
                                                                    email: containerUserCustomRecord
                                                                        .email,
                                                                    uid: containerUserCustomRecord
                                                                        .uid,
                                                                    imgProfile:
                                                                        containerUserCustomRecord
                                                                            .imgProfile,
                          ...
                          builder: (context) => FFButtonWidget(
                            ...
                            options: FFButtonOptions(
                              ...
                              iconPadding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 0.0),
                              color: random_data.randomInteger(0, 10) > 2
                                  ? FlutterFlowTheme.of(context).primary
