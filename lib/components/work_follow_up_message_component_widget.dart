...
import 'work_follow_up_message_component_model.dart';
export 'work_follow_up_message_component_model.dart';

class WorkFollowUpMessageComponentWidget extends StatefulWidget {
  const WorkFollowUpMessageComponentWidget({
    super.key,
  ...
  final int? index;
  final MessageRecord? messageDocData;
  final bool? isSendMessageSuccess;

  @override
  State<WorkFollowUpMessageComponentWidget> createState() =>
      _WorkFollowUpMessageComponentWidgetState();
}

class _WorkFollowUpMessageComponentWidgetState
    extends State<WorkFollowUpMessageComponentWidget>
    with TickerProviderStateMixin {
  late WorkFollowUpMessageComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkFollowUpMessageComponentModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        if (widget.messageDocData?.userEmployeeId !=
                        ...
                        if (widget.messageDocData?.messageType != 'setting') {
                          return Row(
                            ...
                            children: [
                              Builder(
                                builder: (context) {
                                  if (widget.messageDocData?.senderType !=
                                      'system') {
                                    return Align(
                                      alignment:
                                      ...
                                      child: wrapWithModel(
                                        model:
                                            _model.profileDisplayComponentModel,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: ProfileDisplayComponentWidget(
                                          branchCode: widget
                                              .messageDocData!.userBranchCode,
                                        ),
                                      ),
                                    );
                                  } else {
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Hero(
                                      tag: widget.messageDocData!.messageImage,
                                      transitionOnUserGestures: true,
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(16.0),
